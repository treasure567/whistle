      ...
      <section className="pb-24">
        <div className="mx-auto grid max-w-7xl gap-4 px-6 md:grid-cols-3 md:px-10">
          {FEATURES.map(({ href, title, hint, Icon }) => (
            ...
            >
              <span className="flex size-11 items-center justify-center rounded-xl border border-white/10 text-violet-300">
                <Icon size={20} />
              </span>
              <div className="flex-1">
                <h2 className="text-lg font-semibold tracking-tight text-zinc-100">{title}</h2>
                <p className="mt-1.5 text-[13px] leading-relaxed text-zinc-400">{hint}</p>
              </div>
