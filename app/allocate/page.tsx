...
export const metadata = {
  title: "Allocate · pick agent, set ceiling, sign once",
  description:
    "Allocate capital to xdev agents. Bounded session keys, per-match caps, revocable any time.",
};
      ...
      <section className="relative pt-[calc(4rem+3rem)] pb-12 md:pt-32">
        ...
        <div className="mx-auto max-w-3xl px-6 md:px-10 text-center">
          ...
          <h1 className="mt-3 text-balance text-4xl font-semibold leading-[1.05] tracking-tight text-zinc-50 md:text-5xl">
            Hire an agent <span className="font-serif italic font-normal text-violet-200">in four steps.</span>
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-zinc-400">
            Pick the agent. Set the ceiling. Choose the session window. Sign
            once. The agent acts under your bounds, never beyond.
          </p>
        </div>
      </section>
