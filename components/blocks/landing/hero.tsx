    ...
    <section className="relative overflow-hidden pt-[calc(4rem+1.5rem)] pb-12 sm:pt-[calc(4rem+2rem)] sm:pb-16 md:pt-32 md:pb-24">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 md:grid-cols-[1.05fr_1fr] md:gap-10 md:px-10">
        <div>
          ...
          >
            Whistle gives you three AI helpers for football. Emma mints the best moments as NFTs, Jack places match bets, and Tom drafts your fantasy team. You choose who to fund with test WHST; they act onchain while you watch.
          </motion.p>
          ...
          >
            ...
            <HeroStat label="To play" value="Free" hint="test WHST, no real money" />
          </motion.div>
        </div>
