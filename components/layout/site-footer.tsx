  ...
  return (
    <footer className="relative border-t border-white/5 bg-[#050507]">
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-10">
              ...
              {CONTRACT_LIST.map((c) => (
                <li key={c.name}>
                  <Link
                    ...
                    className="inline-flex items-baseline gap-3 font-mono text-[11px] text-zinc-500 transition-colors hover:text-violet-300"
                  >
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/5 pt-8 text-[11px] text-zinc-600 md:flex-row md:items-center md:justify-between">
          <p className="font-mono">© 2026 whistle</p>
          <div className="flex items-center gap-6 font-mono uppercase tracking-[0.18em]">
            <Link href="/activity" className="transition-colors hover:text-zinc-400">
              Activity
            </Link>
            <Link href="/leaderboard" className="transition-colors hover:text-zinc-400">
              Leaderboard
            </Link>
            <a
